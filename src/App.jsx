// PSTTobacco.jsx — Postnieks Impossibility Program · SAPM Companion Dashboard
...
const CROSS_DOMAIN = [
        ...
        { domain:"Gene Drives", beta:"12.4", type:"Impossibility", pi:"$965B" },
    ...
    <div style={{background:C.bg,minHeight:'100vh',fontFamily:C.mono,color:C.text}}>
      ...
      <div style={{padding:"24px",background:C.panel,border:"2px solid #D9770640",borderRadius:4,margin:"24px 0"}}>
        ...
        <div style={{display:"flex",alignItems:"baseline",gap:12,marginBottom:12}}>
          <span style={{fontFamily:C.mono,fontSize:42,fontWeight:700,color:"#D97706"}}>𝒮_W = 0.15</span>
        </div>
